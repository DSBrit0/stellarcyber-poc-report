...
import { ShieldCheck, Eye, EyeOff, Loader, AlertCircle, Zap, Globe, User, Lock } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={connecting}
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-sm transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            style={{
      ...
      <p className="mt-5 text-xs relative z-10" style={{ color: '#1e293b' }}>
        Credenciais ficam apenas em memória e nunca são gravadas em disco.
      </p>
    </div>
  )
}
